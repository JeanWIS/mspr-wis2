...
<div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        ...
        <a href="/mspr-wis2/pages/account/profile.php" class="list-group-item list-group-item-action">Profile</a>
        ...
        <a href="/mspr-wis2/pages/user/friends.php" class="list-group-item list-group-item-action bg-light">All My friends</a>
    </div>
</div>
<!-- /#sidebar -->
